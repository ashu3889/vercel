...
export default function(state = [], action) {
  ...
  switch(action.type) {
     case 'REMOVE_PLOT_PIVOT_DATA_LTF':
    // state = null;
     return [];
    case 'PLOT_PIVOT_DATA_LTF':
   ...
   // // console.log('bonaaaaa');
    ...
    var diffBetweenLowBalckPointBuy = 0.005*factor;
          ...
          //// console.log('most imp directions is...' + action.payload.dir);
            ...
            if(statelen ==1){
               ...
               if(parseFloat(action.payload.y) > state[0].y){
                ...
                if(action.payload.dir == "up"){
                    ...
                    action.payload.upPivotPointsArr =  [{date: action.payload.date, pivot : action.payload.y}];
                }

                if(action.payload.dir == "down"){
                   // {}
                     
                     action.payload.lowPivotPointsArr = [{date: action.payload.date, pivot : action.payload.y}];
                }
            }
            ...
            if(statelen == 2 ){
                ...
                if(action.payload.dir == "up"){
                     ...
                     if(action.payload.upPivotPointsArr == undefined){
                        ...
                        action.payload.upPivotPointsArr =  [...action.payload.upPivotPointsArr, {date: action.payload.date, pivot : action.payload.y}];
                ...
                if(action.payload.dir == "down"){
                      if(action.payload.lowPivotPointsArr == undefined){
                        ...
                        action.payload.lowPivotPointsArr =  [...action.payload.lowPivotPointsArr, {date: action.payload.date, pivot : action.payload.y}] ;
                      }
                }
