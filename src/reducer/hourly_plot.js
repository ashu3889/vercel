...
export default function(state = [], action) {
  ...
  switch(action.type) {
     case 'REMOVE_PLOT_PIVOT_DATA_HOUR':
    // state = null;
     return [];
    case 'PLOT_PIVOT_DATA_HOUR':
    ...
    var diffBetweenLowBalckPointBuy = 0.005*factor;
            ...
            if(statelen ==1){
               ...
               if(parseFloat(action.payload.y) > state[0].y){
                ...
                if(action.payload.dir == "up"){
                    ...
                    action.payload.upPivotPointsArrCandle = [action.payload.completeCandle]
                }

                if(action.payload.dir == "down"){
                    
                     action.payload.lowPivotPointsArr = [parseFloat(action.payload.y)];
                     action.payload.lowPivotPointsArrCandle = [action.payload.completeCandle];
                }
            }
            ...
            if(statelen == 2 ){
                ...
                if(state[statelen-1].upPivotPointsArr != undefined){
                  ...
                  action.payload.upPivotPointsArrCandle = state[statelen-1].upPivotPointsArrCandle;
                } 

                if(state[statelen-1].lowPivotPointsArr != undefined){
                  action.payload.lowPivotPointsArr = state[statelen-1].lowPivotPointsArr;
                  action.payload.lowPivotPointsArrCandle  = state[statelen-1].lowPivotPointsArrCandle ;
                } 
                ...
                if(action.payload.dir == "up"){
                     ...
                     if(action.payload.upPivotPointsArr == undefined){
                        ...
                        action.payload.upPivotPointsArrCandle =  action.payload.upPivotPointsArrCandle.concat(action.payload.completeCandle);
                     }
                }
                ...
                if(action.payload.dir == "down"){
                      if(action.payload.lowPivotPointsArr == undefined){
                        ...
                        action.payload.lowPivotPointsArrCandle =  action.payload.lowPivotPointsArr.concat(action.payload.completeCandle);
                      }
                }
            ...
            if( state.length > 2 ){ 
                ...
                if(state[statelen-1].upPivotPointsArrCandle != undefined){
                  action.payload.upPivotPointsArrCandle  = state[statelen-1].upPivotPointsArrCandle ;
                } 

                if(state[statelen-1].lowPivotPointsArrCandle  != undefined){
                  action.payload.lowPivotPointsArrCandle  = state[statelen-1].lowPivotPointsArrCandle ;
                } 
                ...
                if(action.payload.dir == "up"){
                     ...
                     if(action.payload.upPivotPointsArr == undefined){
                        action.payload.upPivotPointsArr = [parseFloat(action.payload.y)];
                        action.payload.upPivotPointsArrCandle = [parseFloat(action.payload.completeCandle)];
                     }
                     else{
                        action.payload.upPivotPointsArr =  action.payload.upPivotPointsArr.concat(parseFloat(action.payload.y));
                        action.payload.upPivotPointsArrCandle =  action.payload.upPivotPointsArrCandle.concat(action.payload.completeCandle);
                ...
                if(action.payload.dir == "down"){
                      if(action.payload.lowPivotPointsArr == undefined){
                          ...
                          action.payload.lowPivotPointsArr =  action.payload.lowPivotPointsArr.concat(parseFloat(action.payload.y));
                          action.payload.lowPivotPointsArrCandle =  action.payload.lowPivotPointsArrCandle.concat(action.payload.completeCandle);
                      }
                }
            ...
            /*  if(Math.abs(parseFloat(action.payload.y) - state[statelen-1].y) > crudeBigDay){
              ...
              //       }
              //       else if(action.payload.dir == "down" && state[statelen-1].lowest > parseFloat(action.payload.y)){
              //           //set this point as blackline to test 
...
//                       }
//                       else if((state[statelen-1].Lowblackpoint != undefined &&  state[statelen-1].Lowblackpoint != 0) && action.payload.dir =="down"){
...
//                }
              ...
              if(parseFloat(state[statelen-1].highest )>= parseFloat(parseFloat(action.payload.y)) && parseFloat(state[statelen-1].lowest) <= parseFloat(parseFloat(action.payload.y) )){
              ...
              else if(action.payload.dir == "down" && parseFloat(parseFloat(action.payload.y)) > parseFloat(state[statelen-1].highest) && state[statelen-1].trend != 'sideways' ){
                    //time to empty the swing and create a new swing 
              ...
              else if(action.payload.dir == "down" && parseFloat(parseFloat(action.payload.y))< parseFloat(state[statelen-1].lowest) && (state[statelen-1].downcount == undefined || state[statelen-1].downcount ==0)  && state[state.length-1].sidecount < 4){
               ...
               else if(action.payload.dir == "down" && parseFloat(parseFloat(action.payload.y)) < parseFloat(state[statelen-1].Lowblackpoint) && (state[statelen-1].downretesthappen == true)){
              //now time to clear sideways context and make a new trend all together ShortTradeInitiated LongTradeInitiated
                ...
                if(state[statelen-1].Lowblackpoint - parseFloat(action.payload.y) > retestDiff){
                       ...
                       //// console.log('clear sideways all together at' + action.payload.date);
                       action.payload.upretesthappen = false;
                       action.payload.downretesthappen = false;
              ...
              //now time to clear sideways context and make a new trend all together
                ...
                // //// console.log('x');
                  ...
                  else if(action.payload.dir == "down" && parseFloat(parseFloat(action.payload.y)) < parseFloat(state[statelen-1].lowest) && state[state.length-1].sidecount < 4 && state[statelen-1].downcount == 1 ){
                    //time to empty the swing and create a new swing 
